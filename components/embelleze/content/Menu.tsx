    ...
    <div class="flex justify-between w-11/12 m-auto max-w-[1300px] gap-4 flex-col md:flex-row bg-gray-100 md:bg-transparent py-4 my-12">
      <div class="md:flex flex-col hidden gap-4 min-w-[300px]">
        <div class="flex gap-4 items-center">
          <Icon id="EmbellezeLogoSecondary" class="bg-primary rounded-full p-1" size={40} />
         <h2 class="text-primary text-base uppercase font-semibold"> menu institucional</h2>
        </div>
      ...
      <h1 class="flex w-11/12 m-auto text-2xl text-primary uppercase font-semibold justify-center">{Institutional.title}</h1>
